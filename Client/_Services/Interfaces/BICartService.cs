...
//        Task<Result<BaseResponse<AddItemResponse>>> AddToCartAsync(AddCartItemDto addItemRequest);
...
//        Task<Result<BaseResponse<bool>>> CheckoutAsync(CheckoutCartDto checkoutRequest, CancellationToken cancellationToken = default);
